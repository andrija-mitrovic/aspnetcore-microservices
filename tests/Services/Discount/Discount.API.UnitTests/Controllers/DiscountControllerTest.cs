...
namespace Discount.API.UnitTests.Controllers
{
    public class DiscountControllerTest
    {
        ...
        [Fact]
        public async Task GetDiscount_ShouldReturnDiscount_WhenDiscountByProductNameExists()
        {
            //Arrange
        ...
        [Fact]
        public async Task CreateDiscount_ShouldCreateDiscount_WhenCreateRequestIsValid()
        {
            //Arrange
            var coupon = GetCoupon();

            _discountRepository.Setup(x => x.CreateDiscount(It.IsAny<Coupon>())).ReturnsAsync(value: true);
        ...
        [Fact]
        public async Task DeleteDiscount_ShouldDeleteDiscount_WhenDiscountByProductNameExists()
        {
            //Arrange
