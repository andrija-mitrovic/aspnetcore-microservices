...
namespace Catalog.API.UnitTests.Controllers
{
    public class CatalogControllerTest
    {
        ...
        [Fact]
        public async Task GetProduct_ShouldReturnProducts_WhenProductsExist()
        {
            //Arrange
        ...
        [Fact]
        public async Task GetProduct_ShouldReturnProduct_WhenProductWithIdExists()
        {
            //Arrange
        ...
        [Fact]
        public async Task GetProduct_ShouldReturnNotFound_WhenProductWithIdDoesntExist()
        {
            //Arrange
        ...
        [Fact]
        public async Task GetProductByName_ShouldReturnNotFound_WhenProductsByNameDontExist()
        {
            //Arrange
        ...
        [Fact]
        public async Task CreateProduct_ShouldCreateProduct_WhenCreateRequestIsValid()
        {
            //Arrange
            var product = GetProducts().FirstOrDefault();
        ...
        [Fact]
        public async Task DeleteProduct_ShouldDeleteProduct_WhenProductWithIdExists()
        {
            //Arrange
